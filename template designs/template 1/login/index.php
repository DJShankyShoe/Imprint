    ...
    <div class="container">
        ...
        if (isset($_POST['is_login'])) {
            ...
            foreach ($userlist as $user) {
                ...
                if ($user_details[0] == $_POST['username'] && $user_details[1] == $_POST['password']) {
                    $success = true;
                    break;
                }
            }
            ...
            if ($success) {
                ...
                logLoginStatus($_POST['username'], $auth->getUID(), "successful");
                ...
                logLoginStatus($_POST['username'], $failUID, "failed");
            }
        }
